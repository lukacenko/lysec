...
class Template576b865d1596914e983b2a8f8ad2ffd9 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('e5ab278dee', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbf72d0c2fe9_content')) { function _lbf72d0c2fe9_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="content">
    <div class="container">	

        <div class="container-fluid">
            <div class="row">
<?php $_b->templates['e5ab278dee']->renderChildTemplate("layout.latte", $template->getParameters()) ?>
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb45ca221a0f_scripts')) { function _lb45ca221a0f_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
