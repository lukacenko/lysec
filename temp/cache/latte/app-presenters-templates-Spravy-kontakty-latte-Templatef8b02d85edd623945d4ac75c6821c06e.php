<?php
// source: C:\xampp\htdocs\Lysec\app\presenters/templates/Spravy/kontakty.latte

class Templatef8b02d85edd623945d4ac75c6821c06e extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('88e1de4ae2', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbe4767c9bb6_content')) { function _lbe4767c9bb6_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="content">
    <div class="container">	

        <div class="container-fluid">
            <div class="row">
<?php $_b->templates['88e1de4ae2']->renderChildTemplate("layout.latte", $template->getParameters()) ?>
                <div class="col-md-9 current-chat">
                    <div class="row chat-toolbar-row">
                        <div class="col-sm-12">
                            <div class="btn-group chat-toolbar" role="group" aria-label="...">
                                <h3 class="bars"> <?php ob_start() ?>Zoznam mojích kontaktov<?php echo Latte\Runtime\Filters::escapeHtml($template->translate(ob_get_clean()), ENT_NOQUOTES) ?> </h3>
                            </div>
                        </div>
                    </div>
...
<?php $iterations++; } $_l->tmp = $_control->getComponent("favoriteUserGrid"); if ($_l->tmp instanceof Nette\Application\UI\IRenderable) $_l->tmp->redrawControl(NULL, FALSE); $_l->tmp->render() ?>
                </div>
            </div>
        </div>
    </div>
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb719c9129b6_scripts')) { function _lb719c9129b6_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
