<?php
// source: C:\xampp\htdocs\lysec\app\presenters/templates/Spravy/odoslane.latte

class Template2fe31f8dce82ea487af6e2746559603c extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('7da36a918e', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb448f5a3a6f_content')) { function _lb448f5a3a6f_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="content">
    <div class="container">	

        <div class="container-fluid">
            <div class="row">
<?php $_b->templates['7da36a918e']->renderChildTemplate("layout.latte", $template->getParameters()) ?>
                <div class="col-md-9 current-chat">
                    <div class="row chat-toolbar-row">
                        <div class="col-sm-12">
                            <div class="btn-group chat-toolbar" role="group" aria-label="...">
                                <h3 class="bars"> Zoznam odoslaných správ</h3>
                            </div>
                        </div>
                    </div>
...
<?php $iterations++; } $maxItems = 6 ;$_l->tmp = $_control->getComponent("simpleGridOdoslane"); if ($_l->tmp instanceof Nette\Application\UI\IRenderable) $_l->tmp->redrawControl(NULL, FALSE); $_l->tmp->render() ?>
                </div>
            </div>
        </div>
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb26e24d45a1_scripts')) { function _lb26e24d45a1_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
