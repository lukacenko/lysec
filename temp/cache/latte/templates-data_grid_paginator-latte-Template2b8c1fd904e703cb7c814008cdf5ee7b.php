...
class Template2b8c1fd904e703cb7c814008cdf5ee7b extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('b0b54fff25', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block icon-arrow-left
//
if (!function_exists($_b->blocks['icon-arrow-left'][] = '_lbdba4fefc10_icon_arrow_left')) { function _lbdba4fefc10_icon_arrow_left($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
//
if (!function_exists($_b->blocks['icon-arrow-right'][] = '_lb4edd643d4f_icon_arrow_right')) { function _lb4edd643d4f_icon_arrow_right($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>	<i class="<?php echo Latte\Runtime\Filters::escapeHtml($icon_prefix, ENT_COMPAT) ?>
arrow-right"></i><?php
}}
