...
class Template2904ca477d886d621969a177d818e193 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('a8736a83f5', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb05745ebf47_content')) { function _lb05745ebf47_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="content">
    <div class="container">	

        <div class="container-fluid">
            <div class="row">
<?php $_b->templates['a8736a83f5']->renderChildTemplate("layout.latte", $template->getParameters()) ?>
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb28798f2b33_scripts')) { function _lb28798f2b33_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
