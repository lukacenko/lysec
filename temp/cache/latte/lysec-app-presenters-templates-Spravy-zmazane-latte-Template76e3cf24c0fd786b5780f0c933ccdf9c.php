...
class Template76e3cf24c0fd786b5780f0c933ccdf9c extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('014c22a643', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb48172547d9_content')) { function _lb48172547d9_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="content">
    <div class="container">	

        <div class="container-fluid">
            <div class="row">
<?php $_b->templates['014c22a643']->renderChildTemplate("layout.latte", $template->getParameters()) ?>
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb2b8a94a8d4_scripts')) { function _lb2b8a94a8d4_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
