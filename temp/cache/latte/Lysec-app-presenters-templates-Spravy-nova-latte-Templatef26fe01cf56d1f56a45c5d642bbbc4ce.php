...
?><div class="content">
    <div class="container">	
        ...
        <div class="container-fluid">
            <div class="row">
<?php $_b->templates['ea440d8a50']->renderChildTemplate("layout.latte", $template->getParameters()) ?>
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb29ee906247_scripts')) { function _lb29ee906247_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><script>
