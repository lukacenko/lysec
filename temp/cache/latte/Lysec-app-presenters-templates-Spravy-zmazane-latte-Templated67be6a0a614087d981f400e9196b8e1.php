<?php
// source: C:\xampp\htdocs\Lysec\app\presenters/templates/Spravy/zmazane.latte

class Templated67be6a0a614087d981f400e9196b8e1 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('9764d98228', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbe29ec9a434_content')) { function _lbe29ec9a434_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="content">
    <div class="container">	

        <div class="container-fluid">
            <div class="row">
<?php $_b->templates['9764d98228']->renderChildTemplate("layout.latte", $template->getParameters()) ?>
                <div class="col-md-9 current-chat">
                    <div class="row chat-toolbar-row">
                        <div class="col-sm-12">
                            <div class="btn-group chat-toolbar" role="group" aria-label="...">
                                <h3 class="bars"> Zoznam zmazaných správ</h3>
                            </div>
                        </div>
                    </div>
...
<?php $iterations++; } $_l->tmp = $_control->getComponent("simpleGridZmazane"); if ($_l->tmp instanceof Nette\Application\UI\IRenderable) $_l->tmp->redrawControl(NULL, FALSE); $_l->tmp->render() ?>
                </div>
            </div>
        </div>
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb718130bc3d_scripts')) { function _lb718130bc3d_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
