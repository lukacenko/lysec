...
class Templated34d403a3590eef3cef15a95cd6631ac extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('0407e079b8', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block _grid
//
if (!function_exists($_b->blocks['_grid'][] = '_lb2d6f459098__grid')) { function _lb2d6f459098__grid($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('grid', FALSE)
...
// block _gridSnippets
//
if (!function_exists($_b->blocks['_gridSnippets'][] = '_lbd405ded095__gridSnippets')) { function _lbd405ded095__gridSnippets($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('gridSnippets', FALSE)
...
// block outer-filters
//
if (!function_exists($_b->blocks['outer-filters'][] = '_lb7ba4eaff02_outer_filters')) { function _lb7ba4eaff02_outer_filters($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block icon-filter
//
if (!function_exists($_b->blocks['icon-filter'][] = '_lbbd58b2cc77_icon_filter')) { function _lbbd58b2cc77_icon_filter($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block table-class
//
if (!function_exists($_b->blocks['table-class'][] = '_lb6e6f08bfdd_table_class')) { function _lb6e6f08bfdd_table_class($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block _table
//
if (!function_exists($_b->blocks['_table'][] = '_lb4419ef134a__table')) { function _lb4419ef134a__table($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('table', FALSE)
...
// block data
//
if (!function_exists($_b->blocks['data'][] = '_lb62c2aa8362_data')) { function _lb62c2aa8362_data($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block header
//
if (!function_exists($_b->blocks['header'][] = '_lbefe4409808_header')) { function _lbefe4409808_header($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>				<thead>
...
// block group-actions
//
if (!function_exists($_b->blocks['group-actions'][] = '_lb86ed9605ab_group_actions')) { function _lb86ed9605ab_group_actions($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block group_actions
//
if (!function_exists($_b->blocks['group_actions'][] = '_lb7d79ebdb7e_group_actions')) { function _lb7d79ebdb7e_group_actions($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block _exports
//
if (!function_exists($_b->blocks['_exports'][] = '_lbc563274f3f__exports')) { function _lbc563274f3f__exports($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('exports', FALSE)
...
// block exports
//
if (!function_exists($_b->blocks['exports'][] = '_lb1823c30c66_exports')) { function _lb1823c30c66_exports($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block settings
//
if (!function_exists($_b->blocks['settings'][] = '_lbcb29b1989e_settings')) { function _lbcb29b1989e_settings($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block icon-gear
//
if (!function_exists($_b->blocks['icon-gear'][] = '_lb1715d7f12d_icon_gear')) { function _lb1715d7f12d_icon_gear($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block icon-checked
//
if (!function_exists($_b->blocks['icon-checked'][] = '_lbb76b5ecf6a_icon_checked')) { function _lbb76b5ecf6a_icon_checked($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
//
if (!function_exists($_b->blocks['icon-unchecked'][] = '_lb2ca7a20377_icon_unchecked')) { function _lb2ca7a20377_icon_unchecked($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block icon-eye
//
if (!function_exists($_b->blocks['icon-eye'][] = '_lb1e9c4695e8_icon_eye')) { function _lb1e9c4695e8_icon_eye($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><i class="<?php echo Latte\Runtime\Filters::escapeHtml($icon_prefix, ENT_COMPAT) ?>
eye"></i><?php
}}
...
// block icon-repeat
//
if (!function_exists($_b->blocks['icon-repeat'][] = '_lbefdc3bf9ac_icon_repeat')) { function _lbefdc3bf9ac_icon_repeat($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><i class="<?php echo Latte\Runtime\Filters::escapeHtml($icon_prefix, ENT_COMPAT) ?>
repeat"></i><?php
}}
...
//
if (!function_exists($_b->blocks['header-column-row'][] = '_lb7c026d98d6_header_column_row')) { function _lb7c026d98d6_header_column_row($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>					<tr>
...
//
if (!function_exists($_b->blocks['_thead-group-action'][] = '_lb973405e717__thead_group_action')) { function _lb973405e717__thead_group_action($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('thead-group-action', FALSE)
...
// block icon-sort-up
//
if (!function_exists($_b->blocks['icon-sort-up'][] = '_lbd6ce242af3_icon_sort_up')) { function _lbd6ce242af3_icon_sort_up($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
//
if (!function_exists($_b->blocks['icon-sort-down'][] = '_lb2769506a02_icon_sort_down')) { function _lb2769506a02_icon_sort_down($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block icon-sort
//
if (!function_exists($_b->blocks['icon-sort'][] = '_lbe5d6c538ad_icon_sort')) { function _lbe5d6c538ad_icon_sort($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
//
if (!function_exists($_b->blocks['icon-caret-down'][] = '_lbf2099e89c6_icon_caret_down')) { function _lbf2099e89c6_icon_caret_down($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>											<i class="<?php echo Latte\Runtime\Filters::escapeHtml($icon_prefix, ENT_COMPAT) ?>caret-down"></i>
<?php
}}
...
//
if (!function_exists($_b->blocks['icon-eye-slash'][] = '_lb3eaf47e987_icon_eye_slash')) { function _lb3eaf47e987_icon_eye_slash($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>													<i class="<?php echo Latte\Runtime\Filters::escapeHtml($icon_prefix, ENT_COMPAT) ?>
eye-slash"></i><?php
}}
...
// block icon-remove
//
if (!function_exists($_b->blocks['icon-remove'][] = '_lb4c6d13254c_icon_remove')) { function _lb4c6d13254c_icon_remove($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
//
if (!function_exists($_b->blocks['header-filters'][] = '_lbfc4ac14ea8_header_filters')) { function _lbfc4ac14ea8_header_filters($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php if (isset($_b->blocks["$filter_block"])) { Latte\Macros\BlockMacrosRuntime::callBlock($_b, $filter_block, array('filter' => $filters[$key], 'input' => $i, 'outer' => FALSE) + $template->getParameters()) ;} else { if (isset($_b->blocks["$filter_type_block"])) { Latte\Macros\BlockMacrosRuntime::callBlock($_b, $filter_type_block, array('filter' => $filters[$key], 'input' => $i, 'outer' => FALSE) + $template->getParameters()) ;} else { $_b->templates['0407e079b8']->renderChildTemplate($filters[$key]->getTemplate(), array('filter' => $filters[$key], 'input' => $i, 'outer' => FALSE) + $template->getParameters()) ;} } ?>
...
// block tbody
//
if (!function_exists($_b->blocks['tbody'][] = '_lb8387a564de_tbody')) { function _lb8387a564de_tbody($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block _tbody
//
if (!function_exists($_b->blocks['_tbody'][] = '_lb82ee64cd0e__tbody')) { function _lb82ee64cd0e__tbody($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('tbody', FALSE)
...
// block _items
//
if (!function_exists($_b->blocks['_items'][] = '_lb4e99ae4028__items')) { function _lb4e99ae4028__items($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('items', FALSE)
...
<?php $iterations = 0; foreach ($actions as $key => $action) { if ($row->hasAction($key)) { if ($action->hasTemplate()) { $_b->templates['0407e079b8']->renderChildTemplate($action->getTemplate(), array_merge(array('item' => $item, ), $action->getTemplateVariables(), array( 'row' => $row)) + $template->getParameters()) ;} else { ?>
...
<?php } elseif ($items_detail) { ?>
											<td colspan="<?php echo Latte\Runtime\Filters::escapeHtml($control->getColumnsCount(), ENT_COMPAT) ?>">
												<div class="item-detail-content">
<?php if ($items_detail->getType() == 'template') { $_b->templates['0407e079b8']->renderChildTemplate($items_detail->getTemplate(), array_merge(array(), $item_detail_params, array()) + $template->getParameters()) ;} else { ?>
...
// block icon-arrows-v
//
if (!function_exists($_b->blocks['icon-arrows-v'][] = '_lbf7d5e30a5a_icon_arrows_v')) { function _lbf7d5e30a5a_icon_arrows_v($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block _summary
//
if (!function_exists($_b->blocks['_summary'][] = '_lb1dd4f0c90b__summary')) { function _lb1dd4f0c90b__summary($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('summary', FALSE)
...
// block noItems
//
if (!function_exists($_b->blocks['noItems'][] = '_lbdbe22dc256_noItems')) { function _lbdbe22dc256_noItems($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;if (!$rows) { ?>							<tr>
								<td colspan="<?php echo Latte\Runtime\Filters::escapeHtml($control->getColumnsCount(), ENT_COMPAT) ?>">
...
// block tfoot
//
if (!function_exists($_b->blocks['tfoot'][] = '_lb4f9c9e6343_tfoot')) { function _lb4f9c9e6343_tfoot($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block _pagination
//
if (!function_exists($_b->blocks['_pagination'][] = '_lb6a24e0f5d3__pagination')) { function _lb6a24e0f5d3__pagination($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('pagination', FALSE)
...
// block pagination
//
if (!function_exists($_b->blocks['pagination'][] = '_lb19c7ae54f0_pagination')) { function _lb19c7ae54f0_pagination($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>							<tr>
...
// block inlineAddRow
//
if (!function_exists($_b->blocks['inlineAddRow'][] = '_lbf2c0ee7f24_inlineAddRow')) { function _lbf2c0ee7f24_inlineAddRow($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
//
if (!function_exists($_b->blocks['columnsSummary'][] = '_lba05692d0ee_columnsSummary')) { function _lba05692d0ee_columnsSummary($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
//
if (!function_exists($_b->blocks['aggregationFunctions'][] = '_lbc6a43e60ce_aggregationFunctions')) { function _lbc6a43e60ce_aggregationFunctions($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;$iterations = 0; foreach ($columns as $key => $column) { $td = $column->getElementForRender('td', $key) ?>
...
// block column-header
//
if (!function_exists($_b->blocks['column-header'][] = '_lba0ed604d03_column_header')) { function _lba0ed604d03_column_header($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
