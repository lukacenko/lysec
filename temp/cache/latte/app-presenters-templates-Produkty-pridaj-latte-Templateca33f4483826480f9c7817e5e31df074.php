...
<?php $iterations++; } ?>
            ...
            <?php echo Nette\Bridges\FormsLatte\Runtime::renderFormBegin($form = $_form = $_control["form"], array()) ?>
                ...
                <div class="form-group">
                    <span><?php if ($_label = $_form["shop"]->getLabel()) echo $_label  ?></span>
                    <?php echo $_form["shop"]->getControl() ?>
                ...
                <div class="form-group">
                    <span><?php if ($_label = $_form["subor"]->getLabel()) echo $_label  ?></span>
                    <?php echo $_form["subor"]->getControl() ?>
